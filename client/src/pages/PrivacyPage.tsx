          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                <Card>
                  <CardHeader>
                    <CardTitle>1. Introduction & Data Protection Overview</CardTitle>
                  </CardHeader>
                  <CardContent className="prose prose-slate dark:prose-invert max-w-none">
                    ...
                    <ul>
                      <li>Only collect data necessary for providing our services</li>
                      <li>Process data lawfully, fairly, and transparently</li>
                      <li>Keep your data secure using industry-standard encryption</li>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>7. Your Data Protection Rights (UK GDPR)</CardTitle>
                  </CardHeader>
                  <CardContent className="prose prose-slate dark:prose-invert max-w-none">
                    <p>
                ...
                <Card>
                  ...
                  <CardContent className="prose prose-slate dark:prose-invert max-w-none">
                    ...
                    <ul>
                      ...
                      <li>Security cookies to prevent fraud and secure access</li>
                ...
                <Card>
                  ...
                  <CardContent className="prose prose-slate dark:prose-invert max-w-none">
                    <p>
                      ...
                      need to report a data protection concern, please contact us:
                    </p>
                    <p>
                      <strong>Email:</strong> support@equiprofile.online
                      <br />
                    ...
                    <p>
                      ...
                      <br />
                      <strong>Website:</strong> <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://ico.org.uk</a>
                      <br />
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>13. UK GDPR Compliance & Legal Basis for Processing</CardTitle>
                  </CardHeader>
                  <CardContent className="prose prose-slate dark:prose-invert max-w-none">
                    <p>
                    ...
                    <p><strong>1. Contract Performance</strong></p>
                    <p>
                    ...
                    <ul>
                      ...
                      <li>Specific data processing activities requiring consent</li>
                    </ul>
                    <p>
                    ...
                    <p><strong>3. Legitimate Interests</strong></p>
                    <p>
                    ...
                    <p><strong>4. Legal Obligation</strong></p>
                    <p>
                    ...
                    <p>
                      ...
                      Where we transfer data outside the UK, we ensure appropriate
