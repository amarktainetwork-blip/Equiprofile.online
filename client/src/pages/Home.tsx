  ...
  const features = [
    {
      ...
      description: "Track vaccinations, vet visits, medications, and comprehensive medical history with intelligent automated reminders and alerts.",
      color: "from-red-500 to-pink-500",
    },
    {
      icon: Activity,
      title: "Advanced Training Management",
      description: "Plan training sessions, log detailed progress, and track performance metrics with AI-powered analytics and insights.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: Utensils,
      title: "Smart Feeding Schedules",
      description: "Create custom feeding plans with precision nutrition tracking, meal reminders, and dietary recommendations.",
      color: "from-green-500 to-emerald-500",
    },
    {
      icon: Calendar,
      title: "Integrated Calendar & Events",
      description: "Never miss appointments with smart scheduling, automatic notifications, and seamless calendar integration.",
      color: "from-purple-500 to-violet-500",
    },
    {
      icon: CloudSun,
      title: "AI Weather Intelligence",
      description: "Get real-time weather analysis and intelligent riding recommendations based on current and forecasted conditions.",
      color: "from-amber-500 to-yellow-500",
    },
    {
      icon: FileText,
      title: "Secure Document Vault",
      description: "Store all important papers, records, certificates, and documents in one encrypted, easily accessible location.",
  ...
  const testimonials = [
    {
      ...
      content: "EquiProfile has completely revolutionized how I manage my horses. The health tracking and intelligent reminders have been absolutely invaluable for maintaining peak performance!",
      rating: 5,
      avatar: "ST",
    },
    {
      ...
      content: "Managing a large stable used to be overwhelming. EquiProfile makes it simple, organized, and efficient. The time savings alone have been incredible. Highly recommend!",
      rating: 5,
      avatar: "MC",
    },
    {
      ...
      content: "The training logs and analytics are phenomenal. I can see progress clearly, identify areas for improvement, and share detailed updates with clients easily. Game-changing!",
      rating: 5,
      avatar: "ER",
    },
  ];
        ...
        <div className="min-h-screen overflow-hidden">
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
              ...
              {/* Floating particles */}
              <div className="absolute top-20 left-10 w-64 h-64 particle animate-float" style={{ animationDelay: '0s' }} />
              <div className="absolute bottom-20 right-10 w-96 h-96 particle animate-float" style={{ animationDelay: '2s' }} />
              <div className="absolute top-1/3 right-1/4 w-32 h-32 particle animate-float" style={{ animationDelay: '4s' }} />
            </div>
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-12" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
                  ...
                  <p className="text-xl md:text-2xl lg:text-3xl text-white/95 mb-12 leading-relaxed max-w-4xl mx-auto drop-shadow-lg font-light">
                    The ultimate digital platform for horse owners, trainers, and equestrian professionals. 
                    Track health, manage training, and provide exceptional care—all in one beautiful place.
                  </p>
                  
                  <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
                    <Link href={isAuthenticated ? "/dashboard" : "/register"}>
                      <Button size="lg" className="text-xl px-10 py-7 bg-white text-primary hover:bg-white/90 shadow-2xl hover:scale-105 transition-all duration-300 group">
                        {isAuthenticated ? "Go to Dashboard" : "Start Free Trial"}
                        <ChevronRight className="w-6 h-6 ml-2 group-hover:translate-x-1 transition-transform" />
                      </Button>
                    </Link>
                    <Link href="/features">
                      <Button size="lg" variant="outline" className="text-xl px-10 py-7 glass-strong text-white border-white/30 hover:bg-white/20 shadow-xl group">
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-16"
                  ...
                  <Card className="glass-strong hover-3d border-white/20 backdrop-blur-xl">
                    <CardContent className="pt-6">
                      ...
                      <p className="text-sm text-muted-foreground">Active professionals worldwide</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="glass-strong hover-3d border-white/20 backdrop-blur-xl">
                    <CardContent className="pt-6">
                      ...
                      <p className="text-sm text-muted-foreground">Horses managed daily</p>
                    </CardContent>
                  </Card>
              ...
              <ScrollReveal>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  {stats.map((stat, index) => (
                    <div key={index} id={`stat-${index}`} className="text-center">
                      <div className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-3">
                        {animatedStats[index].toFixed(stat.value % 1 === 0 ? 0 : 1)}{stat.suffix}
                      </div>
            ...
            <div className="container relative z-10">
              <ScrollReveal>
                <div className="text-center max-w-3xl mx-auto mb-20">
                  ...
                  <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
                    ...
                    you need to keep your horses healthy, happy, and performing at their absolute best.
                  </p>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <div className="text-center mt-16">
                  <Link href="/features">
                    <Button size="lg" className="text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all group">
                ...
                <Card className="p-10 md:p-16 lg:p-20 bg-gradient-to-br from-primary via-primary to-accent text-white border-0 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="text-center max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                      <Link href="/pricing">
                        <Button size="lg" className="text-xl px-10 py-7 bg-white text-primary hover:bg-white/90 shadow-xl hover:scale-105 transition-all">
                          View Pricing Plans
                        </Button>
                      </Link>
                      <Link href="/register">
                        <Button size="lg" variant="outline" className="text-xl px-10 py-7 border-white/30 text-white hover:bg-white/10">
                          Start Free Trial
                        </Button>
                      </Link>
                    </div>
            ...
            <div className="container">
              <ScrollReveal>
                <div className="text-center max-w-4xl mx-auto">
                  ...
                  <Link href="/register">
                    <Button size="lg" className="text-xl px-12 py-8 shadow-2xl hover:shadow-3xl hover:scale-105 transition-all group">
              ...
              <div className="grid md:grid-cols-4 gap-12 mb-12">
                <div className="md:col-span-2">
                  ...
                  <p className="text-muted-foreground text-base mb-6 max-w-md">
                    Professional horse management platform for the modern equestrian. 
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li><Link href="/features"><a className="hover:text-foreground transition-colors hover:underline">Features</a></Link></li>
                    <li><Link href="/pricing"><a className="hover:text-foreground transition-colors hover:underline">Pricing</a></Link></li>
                    <li><Link href="/dashboard"><a className="hover:text-foreground transition-colors hover:underline">Dashboard</a></Link></li>
                    <li><Link href="/about"><a className="hover:text-foreground transition-colors hover:underline">About Us</a></Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-muted-foreground">
                    <li><Link href="/contact"><a className="hover:text-foreground transition-colors hover:underline">Contact</a></Link></li>
