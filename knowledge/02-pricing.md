...
- Switch plans any time — changes are prorated automatically
...
4. Complete registration → automatically redirected to Stripe Checkout
5. After payment → account upgraded and you land on your Dashboard
...
- **Can I upgrade mid-trial?** Yes, subscribe any time and the trial ends immediately.
- **Can I export my data?** Yes, all paid plans include CSV/PDF export.
